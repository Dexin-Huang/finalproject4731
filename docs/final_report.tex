...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{figures/sam3_pipeline_composite.png}
    \caption{SAM3D Body processing visualization showing the 4-frame temporal sequence (t-2 to t+1) used for prediction. Each row shows: original frame, skeleton detection, colorized mesh overlay, and isolated 3D body. The model analyzes motion patterns across this sequence to predict shot outcome.}
